...
public abstract class BaseActivity extends AppCompatActivity {
  ...
  private void showCrashLoggingPermissionDialog() {
    ...
    permissionDialogFragment.setPrimaryColor(
        getResources().getColor(R.color.Actionbar_TopList_Background));
    ...
    permissionDialogFragment.setPositiveButton(R.string.dialog_crashlogging_positive,
    ...
    permissionDialogFragment.setNegativeButton(R.string.dialog_crashlogging_negative,
        new DialogInterface.OnClickListener() {
          @Override public void onClick(DialogInterface dialogInterface, int i) {
            WallyApplication.getDataProviderInstance()
                .getSharedPreferencesDataProviderInstance()
                .setUserApprovedCrashLogging(
                    SharedPreferencesDataProvider.CRASH_LOGGING_NOT_APPROVED);
